...
ActiveRecord::Schema[7.0].define(version: 2023_05_15_225308) do
  ...
  create_table "lots", force: :cascade do |t|
    ...
    t.index ["bid_user_id"], name: "index_lots_on_bid_user_id"
  end
  ...
  add_foreign_key "lots", "users", column: "bid_user_id"
end
